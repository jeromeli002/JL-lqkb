...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] =   { ENCODER_CCW_CW(DIAL_L, DIAL_R),    ENCODER_CCW_CW(DIAL_L, DIAL_R),  ENCODER_CCW_CW(DIAL_L, DIAL_R)  },
    [1] =   { ENCODER_CCW_CW(KC_TRNS, KC_TRNS),  ENCODER_CCW_CW(DIAL_L, DIAL_R),  ENCODER_CCW_CW(DIAL_L, DIAL_R)  },
