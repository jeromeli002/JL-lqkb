...
# MCU 名称 (MCU Name)
MCU = STM32F103 # 指定使用的微控制器为 STM32F103
MCU_LDSCRIPT = STM32F103xB # 指定链接器脚本，用于 STM32F103xB 变体

# 引导加载程序选择 (Bootloader Selection)
#BOOTLOADER = uf2boot    # 生成 uf2 固件 (注释掉表示不使用 uf2 引导)
BOOTLOADER = vibl      # 生成 vfw 固件 (当前使用 vibl 引导)
# BOARD = STM32_F103_STM32DUINO # 板子类型，此处未定义
# BOOTLOADER = tinyuf2 # tinyuf2 引导加载程序，此处未启用

# 编译选项 (Build Options)
# 注释掉以禁用该选项 (Comment out to disable the options)
