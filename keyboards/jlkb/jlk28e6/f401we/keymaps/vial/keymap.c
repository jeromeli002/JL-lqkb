...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 LAYOUT(
		BLE_SW1, BLE_SW2, BLE_SW3,  BLE_RESET, KC_M, KC_N, KC_O, KC_P, 
		BLE_TOG, RF_TOG, USB_TOG, BLE_OFF, KC_E, KC_F, KC_G, KC_H, 
		BLE_RESET, KC_J, KC_K, KC_L, KC_L, KC_C, KC_C, KC_Q, 
		KC_R, KC_S, KC_T, KC_U, KC_U, KC_W, KC_X, KC_Y, 
		KC_Z, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, 
		KC_8, KC_9, KC_TRNS, KC_TRNS, KC_TRNS, KC_F, KC_F, KC_TRNS, 
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] =   { ENCODER_CCW_CW(KC_A, KC_B),    ENCODER_CCW_CW(KC_C, KC_D) ,    ENCODER_CCW_CW(KC_E, KC_F) ,    ENCODER_CCW_CW(KC_G, KC_H),    ENCODER_CCW_CW(KC_I, KC_J),    ENCODER_CCW_CW(KC_K, KC_L),    ENCODER_CCW_CW(KC_M, KC_N)  },
    [1] =   { ENCODER_CCW_CW(KC_A, KC_A),    ENCODER_CCW_CW(KC_A, KC_A) ,    ENCODER_CCW_CW(KC_A, KC_A) ,    ENCODER_CCW_CW(KC_A, KC_A),    ENCODER_CCW_CW(KC_A, KC_A),    ENCODER_CCW_CW(KC_A, KC_A),    ENCODER_CCW_CW(KC_K, KC_L)  },
