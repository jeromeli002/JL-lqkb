...
/* key matrix pins */
#define MATRIX_ROW_PINS {  A15,B5,B3,B12,B13}
#define MATRIX_COL_PINS {  B4,A0,A2,A7,A1}

/* COL2ROW or ROW2COL */
#define DIODE_DIRECTION COL2ROW

/* 编码器 */
#define ENCODERS_PAD_A { A6, A4, B9, C14 }
#define ENCODERS_PAD_B { A5, A3, B8, C15 }
