...
#define JOYSTICK_KEY_X_PIN  {A2}
#define JOYSTICK_KEY_Y_PIN  {A1}
#define JOYSTICK_KEY_PX_POS {{2, 1}}  //高电平
#define JOYSTICK_KEY_NX_POS {{3, 2}}  //低电平
#define JOYSTICK_KEY_PY_POS {{3, 1}}  //高电平
#define JOYSTICK_KEY_NY_POS {{3, 0}}  //低电平
