...
#define MATRIX_ROW_PINS {  B3, B4, B5, A10, B0  }
#define MATRIX_COL_PINS {  B12, B13, B14, B15, A8 }
...
#define ENCODER_PAD_A_KEY_POS {0, 1}, {0, 1}, {0, 1}, {0, 1}
#define ENCODER_PAD_B_KEY_POS {1, 1}, {1, 1}, {1, 1}, {1, 1}
