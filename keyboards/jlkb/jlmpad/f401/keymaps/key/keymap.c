...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		DIAL_BUT, KC_RIGHT, KC_LEFT, KC_DOWN, KC_ENTER,
		KC_F2, KC_F5, KC_C, KC_KP_SLASH, KC_UP,
		KC_KP_ASTERISK, KC_KP_MINUS, KC_KP_7, KC_KP_8,  KC_KP_9,
		KC_KP_PLUS, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_1,
		KC_KP_2, KC_KP_3, KC_KP_ENTER, KC_KP_0, KC_KP_DOT,
