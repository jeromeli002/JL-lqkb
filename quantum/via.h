...
enum via_command_id {
    ...
    id_custom_save                          = 0x09,
    id_lighting_set_value                   = 0x07, // 兼容旧 Vial / VIA2
    ...
    id_dynamic_keymap_get_encoder           = 0x14, // VIA3 新增
    id_dynamic_keymap_set_encoder           = 0x15, // VIA3 新增
    id_vial_prefix                          = 0xFE,
    id_unhandled                            = 0xFF,
};
...
enum via_qmk_backlight_value {
    id_qmk_backlight_brightness = 0x09, // 保持旧值以兼容 Vial
